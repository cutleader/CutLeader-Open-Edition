...
IMPLEMENT_DYNAMIC(ImportDxfDwg2DataCenterDlg, CFileDialog)

ImportDxfDwg2DataCenterDlg::ImportDxfDwg2DataCenterDlg(CWnd* pParentWnd) :
...
{
	SetTemplate(0, IDD_clDataImportExportUI_ImportDxfDwg2DataCenter);
	m_iParamConfigID = INVALID_ID;
}

ImportDxfDwg2DataCenterDlg::~ImportDxfDwg2DataCenterDlg()
{
}

void ImportDxfDwg2DataCenterDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(ImportDxfDwg2DataCenterDlg, CFileDialog)
	ON_WM_DESTROY()
    ON_BN_CLICKED(IDC_BTN_SelectCamParam, OnSelectCamParam)
END_MESSAGE_MAP()

BOOL ImportDxfDwg2DataCenterDlg::OnInitDialog()
{
...
void ImportDxfDwg2DataCenterDlg::OnDestroy()
{
	// 释放视口。
	m_ctrlPreviewWnd.ReleaseViewPort();
}

void ImportDxfDwg2DataCenterDlg::OnSelectCamParam()
{
    // 更换板材的加工参数。
...
void ImportDxfDwg2DataCenterDlg::OnFileNameChange()
{
...
BOOL ImportDxfDwg2DataCenterDlg::OnFileNameOK()
{
