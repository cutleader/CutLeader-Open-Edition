...
//------------------------------------------------------------------------
class ClUILib_Export CGridColumnManagerProfile : public CGridColumnManager
{
protected:
...
//------------------------------------------------------------------------
class ClUILib_Export CGridColumnConfig
{
protected:
...
//------------------------------------------------------------------------
class ClUILib_Export CGridColumnConfigDefault : public CGridColumnConfig
{
protected:
...
//------------------------------------------------------------------------
class ClUILib_Export CGridColumnConfigProfiles : public CGridColumnConfigDefault
{
protected:
...
//------------------------------------------------------------------------
class ClUILib_Export CGridColumnConfigWinApp : public CGridColumnConfigProfiles
{
protected:
